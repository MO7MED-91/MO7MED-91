...
const Home = () => {
  ...
  const time = now.toLocaleTimeString('en-SA', { hour: '2-digit', minute: '2-digit' });
  const date = (new Intl.DateTimeFormat('ar-SA', { dateStyle: 'full' })).format(now);
  const date2 = (new Intl.DateTimeFormat('ar-Un', { dateStyle: 'full' })).format(now);
        ...
        <div className="flex h-full flex-col justify-between max-md:px-5 max-md:py-8 lg:p-11">
         ...
         مرحبا بك في تطبيق موكا للأجتماعات
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-lg font-medium text-sky-1 lg:text-2xl">التاريخ : {date}</p>
